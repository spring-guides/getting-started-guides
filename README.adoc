...
[source,xml]
----
include::complete/request.txt[]
----

Execute from command line `curl --header "content-type: text/xml" -d @request.xml "http://localhost:8080/ws/"`. As a result you should see:
