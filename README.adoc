...
Within Xcode, create a new project, using the "Single View Application" template. When you are finished, you can compare your code to the `complete` folder and <<run>>.
