...
This guide walks you through building a simple iOS client in Swift 3.0 that consumes a Spring MVC-based link:/understanding/REST[RESTful web service].

== What you'll build

You will build an iOS client using Swift 3.0 that consumes a Spring-based RESTful web service.
