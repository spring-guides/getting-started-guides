...
`src/main/java/reactiveredis/Coffee.java`
[source,java]
----
include::complete/src/main/java/reactiveredis/Coffee.java[]
----
...
`src/main/java/reactiveredis/CoffeeConfiguration.java`
[source,java]
----
include::complete/src/main/java/reactiveredis/CoffeeConfiguration.java[]
----
...
`src/main/java/reactiveredis/CoffeeLoader.java`
[source,java]
----
include::complete/src/main/java/reactiveredis/CoffeeLoader.java[]
----


== Create a RestController to provide an external interface for our application

`src/main/java/reactiveredis/CoffeeController.java`
[source,java]
----
include::complete/src/main/java/reactiveredis/CoffeeController.java[]
----
...
`src/main/java/reactiveredis/Application.java`
[source,java]
----
include::complete/src/main/java/reactiveredis/Application.java[]
----
