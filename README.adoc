...
It is good security practice that after your database is in production state, you make this `none` AND REVOKE ALL PREVILEGES FROM THE USER CONNECTED TO THE DATABASE, THEN GIVE HIM ONLY CREATE, UPDATE, INSERT, DELETE.
